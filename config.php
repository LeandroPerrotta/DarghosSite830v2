...
//Tasks Map
$g_tasksMap = array(
	1 => array( // Atualizaчуo dos Ranks
		'name' => "highscores",
		'eachTime' => 60 * 60 * 24
	), 
	2 => array( // Atualizaчуo das infos de status dos worlds
		'name' => "worldsstatus",
		'eachTime' => 60 * 10
	),
	3 => array( // Remoчуo de dias de premium/atualizaчуo do lastDay
		'name' => "premiumdays",
		'eachTime' => 60 * 60 * 24
	),
	4 => array( // Atualizaчуo das infos. dos players online
		'name' => "playersinfos",
		'eachTime' => 60 * 10
	),
	5 => array( // Processar as mudanчas de e-mails solicitadas
		'name' => "changeemails",
		'eachTime' => 60 * 60 * 12
	),
	6 => array(
